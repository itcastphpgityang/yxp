...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<input type="hidden" name="picpath" id="hidden_txt_picpath" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>
									<img height="100px" width="100px" id="picpath">
								</td>
							</tr>
							</tr>
							<tr>
	...
	function initEditUser(getSelection){
		...
		//$('#hidden_txt_picpath').val(getSelection.picpath);
		$("#picpath").prop("src","/photo/"+getSelection.picpath);
